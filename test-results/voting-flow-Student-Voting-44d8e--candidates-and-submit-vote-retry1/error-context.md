...
- Name: voting-flow.spec.ts >> Student Voting Flow >> should select candidates and submit vote
- Location: playwright\voting-flow.spec.ts:98:7
...
Locator: locator('text=Select up to').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Select up to').first()
