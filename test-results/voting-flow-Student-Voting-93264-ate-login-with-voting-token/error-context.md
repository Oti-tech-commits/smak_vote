...
Call log:
  - waiting for locator('button:text("Voting Token")')
    - locator resolved to <button type="button" class="rounded-full px-4 py-2 text-sm font-semibold transition bg-slate-100 text-slate-700 hover:bg-slate-200">Voting Token</button>
  ...
  - main [ref=e13]:
    - generic [ref=e14]:
      ...
      - generic [ref=e20]:
        ...
        - generic [ref=e24]:
          - button "Student Number" [ref=e25] [cursor=pointer]
          - button "School Email" [ref=e26] [cursor=pointer]
          - button "Voting Token" [active] [ref=e27] [cursor=pointer]
        - generic [ref=e28]:
          - generic [ref=e29]:
            - generic [ref=e30]: Voting Token
            - textbox "Voting Token" [ref=e31]:
              - /placeholder: Single-use token
          - button "Validate Token" [ref=e32] [cursor=pointer]
  - contentinfo [ref=e33]:
    - generic [ref=e34]:
      - generic [ref=e35]:
        - img "St. Mark’s S.S. Naminya crest" [ref=e36]
        - generic [ref=e37]:
          - paragraph [ref=e38]: St. Mark’s S.S. Naminya
          - paragraph [ref=e39]: Desire to Excel
      - paragraph [ref=e40]: © 2026 St. Mark’s S.S. Naminya. Secure prefect voting platform.
  - alert [ref=e41]
```
