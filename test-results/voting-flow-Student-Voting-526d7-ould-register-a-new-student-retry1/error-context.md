...
- Location: playwright\voting-flow.spec.ts:10:7
...
Locator: locator('text=Registration successful')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Registration successful')
...
- main:
  ...
  - paragraph: Create your account with student number and school email.
  - text: Full Name
  - textbox "Full Name": Test Student
  - text: Student Number
  - textbox "Student Number": TS2024001
  - text: Class Name
  - textbox "Class Name": SS3A
  - text: School Email
  - textbox "School Email": student.test@stmark.com
  - text: Password
  - textbox "Password": TestPassword123!
  - button "Create Account"
  - paragraph: A user with this email address has already been registered
- contentinfo:
  - img "St. Mark’s S.S. Naminya crest"
  - paragraph: St. Mark’s S.S. Naminya
  - paragraph: Desire to Excel
